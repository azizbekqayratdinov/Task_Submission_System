        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @foreach ($subjects as $subject)
                                    <li><a class="nav-link"
                                            href="{{ route('work', [$subject->subject_id]) }}">{{ $subject->subject_name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                        {{-- <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="command"></i><span>Results</span></a>
                            <ul class="dropdown-menu">
                                @foreach ($subjects as $subject)
                                    <li><a class="nav-link"
                                            href="#">{{ $subject->subject_name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li> --}}
            ...
            <div class="main-content">
                <section class="section">
                    <div class="row">
                        @foreach ($work as $v)
                            @if ($v->subject_id == $subject_id and $v->student_id == Auth::user()->id and $v->score == 0)
                                <h3>Sizin jumisiniz tekserilmekte !</h3>
                            @elseif($v->subject_id == $subject_id and $v->student_id == Auth::user()->id and $v->score != 0)
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($works as $val)
                                            <tr>
                                                ...
                                                <td>{{ $val->user_name }}</td>
                                                <td>{{ $val->date }}</td>
                                                <td><a href="../../../files/{{ $val->file_name }}"
                                                        target="_blank">{{ $val->file_name }}</a></td>
                            ...
                            @else
                                <div class="col-lg-9">
                                    <form action="{{ route('work_send') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div>
                                            <label class="label" for="File">Send Work</label>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            <input type="submit" class="btn btn-primary mr-1" value="Send">
                                        </div>
                                    </form>
                                </div>
                            @endif
