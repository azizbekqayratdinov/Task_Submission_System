                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="briefcase"></i><span>My Groups</span></a>
                            <ul class="dropdown-menu">
                                @foreach ($groups as $group)
                                    <li><a style="font-size:12px" class="nav-link"
                                            href="{{ route('teacher_kursovoy', [$group->group_id, $group->subject_id]) }}">{{ $group->group_name }}
                                            | {{ $group->subject_name }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        {{-- <li class="dropdown">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($works as $v)
                                            <tr>
                                                ...
                                                <td>{{ $v->user_name }}</td>
                                                <td>{{ $v->date }}</td>
                                                <td><a href="../../../files/{{ $v->file_name }}"
                                                        target="_blank">{{ $v->file_name }}</a></td>
                                                ...
                                                @if ($v->score == 0)
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('score_store', [$v->work_id, $v->subject_id, $v->group_id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <input type="number" class="form-control"
                                                                placeholder="Score" name="score" id="">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <form
                                                            ...
                                                            <input type="number" disabled disabled
                                                                value="{{ $v->score }}" class="form-control"
                                                                placeholder="Score" name="score" id="">
                                                    <td>
                                                        <input type="submit" disabled value="Detail"
